...
(12,3,'Backup',200,'backupmgr','user','The backup manager module enables you to backup your entire hosting account including all your MySQL&reg; databases.',NULL,'true',NULL,''),
...
(24,4,'MySQL Database',200,'mysql_databases','user','MySQL&reg; databases are used by many PHP applications such as forums and ecommerce systems, below you can manage and create MySQL&reg; databases.',NULL,'true',NULL,''),
...
(39,4,'MySQL Users',200,'mysql_users','user','MySQL&reg; Users allows you to add users and permissions to your MySQL&reg; databases.',NULL,'true',NULL,''),
...
(6,'dbversion','Sentora version','2.1.0',NULL,'Database Version','Sentora Config','false'),
