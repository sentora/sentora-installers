...
sp.disable_function.function("ini_set").value("memory_limit").drop().alias("Warning: PHP Default memory limit is 256MB. Your App/Framework is requesting more. Contact your admin for help.");
sp.disable_function.function("ini_set").value("include_path").drop();
sp.disable_function.function("ini_set").value("open_basedir").drop(); ###### Not Needed due to Apache config open_basedir setup

# Detect some backdoors via environnement recon
# sp.disable_function.function("ini_get") value("allow_url_fopen").drop();
# sp.disable_function.function("ini_get").value("open_basedir").drop(); ###### Not Needed due to Apache config open_basedir setup
